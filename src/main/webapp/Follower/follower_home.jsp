              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> User <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li class="current-page"><a href="home">Followed Risk</a>
                    </li>
                    <li><a href="closedRisk">Closed Risk</a>
                    </li>
                  </ul>
                </li>
              </ul>
                    ...
                    <tbody>
                      ...
                      <s:iterator value="riskList">
                        ...
                        <td><a class="btn btn-primary btn-xs" href="riskDetail?riskId=<s:property value='id'/>">view</a>
							<a class="btn btn-danger btn-xs" href="close?riskId=<s:property value='id'/>">close</a>
						</td>
                        </tr>
                       </s:iterator>
                    </tbody>
